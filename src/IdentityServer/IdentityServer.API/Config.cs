    ...
    public static class Config
    {
        ...
        public static IEnumerable<ApiScope> ApiScopes =>
            new ApiScope[]
            {
                ...
                new ApiScope("order_fullpermission","Order API ucun tam elcatanliliq"),
                new ApiScope("payment_fullpermission","Payment API ucun tam elcatanliliq"),
                new ApiScope("gateway_fullpermission","Payment API ucun tam elcatanliliq"),
